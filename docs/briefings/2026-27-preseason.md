...
## How to use this in Gameweek Edge
...
> You are the Gameweek Edge FPL scout. Use ONLY the pre-season briefing below plus live FPL API data for prices, ownership and form. Do not invent transfers or prices. When set-piece or penalty duty is marked "watch", flag it as unconfirmed. Question: [your question, e.g. "best three sub-£6.0m midfielders for GW1-6" or "who should I captain in the opening month"].
>
> BRIEFING: [paste the team blocks]
...
**Out:** Rasmus Hojlund (FWD, Napoli, ~£43m permanent), Casemiro (MID, released), Jadon Sancho (FWD, released), Tyrell Malacia (DEF, released), Andre Onana (GK, Trabzonspor, loan).

**FPL picks:**
- Value: Bryan Mbeumo and Matheus Cunha both offer strong mid-price returns behind Bruno. A United defender is a budget clean-sheet punt (they conceded under 50 last term).
- Premium / captaincy: Bruno Fernandes (MID, £12.0m). On penalties, direct free-kicks and corners, a genuine set-and-forget captain differential to the City and Arsenal premiums.
...
**Out:** Mohamed Salah (FWD, leaving, Saudi Pro League reported), Ibrahima Konate (DEF, Real Madrid, free), Andy Robertson (DEF, Tottenham, free), fringe and academy sales.

**FPL picks:**
- Value: Hugo Ekitike (FWD, ~£7.5m), leads the line below premium. Florian Wirtz (MID) as a creative hub if fairly priced.
- Premium / captaincy: Alexander Isak (FWD, ~£9.0m), now the focal striker and likely new penalty taker. The key Liverpool captain call with Salah gone.
...
**Pre-season summary:** **20 Aug: Eddie Howe has gone, and this block said otherwise for a fortnight.** Howe stepped down after almost five years; **Matthias Jaissle**, 38, is head coach — a serial winner at RB Salzburg and Al-Ahli, two Asian Champions Leagues in three Saudi seasons, and no English experience whatever. He calls his football "front-footed, aggressive, vertical, high energy, intense and relentless". LazyFPL, the Daily Mail and the official Scout each said Howe was gone; none of them was a full account, which is why the line sat unwritten. The Guardian's season preview (Louise Taylor, 20 Aug) is the fourth source and the first to carry the successor, the tenure and the style together. Underwhelmed to twelfth, and then a selling summer: Tonali (~£100m to Spurs), Gordon (~£69m to Barcelona) and Bruno Guimaraes (Arsenal) all left, reinvested in younger, cheaper talent rather than a like-for-like marquee — four of the first five signings were 20 or under. Nick Woltemade leads the line as main striker and penalty taker. The question is no longer whether Howe can knit a reshaped attack together but whether a head coach who has never worked in England can, and whether he gets more from Woltemade and Yoane Wissa than Howe did.

**In:** Bazoumana Toure (LW, Hoffenheim, ~£43m), Ewen Jaouen (GK, Reims, ~£24m), Sean Steur (CM, Ajax, ~£23m), Aladji Bamba (CM, Monaco, undisclosed). **20 Aug, unresolved: the Guardian's star signing for Newcastle is a different goalkeeper — Lukas Hornicek, 24, Czech Republic, ~£26m from Braga.** Either they signed two keepers or one of the two entries is wrong, and nothing here settles which. Recorded as a conflict rather than swapped in. Toure, Steur and Bamba are corroborated by the same preview. Added 13 Aug, having been recorded only by the club at the other end: Anthony Elanga (W, Nott'm Forest, ~£55m).
...
- Premium / captaincy: Nick Woltemade, nailed striker and penalty taker, main goal threat. **20 Aug: Bruno Guimaraes struck from this line.** The Out list has recorded him at Arsenal since 13 Aug and the Guardian preview confirms it, yet he was still being recommended here — a departed player served as a pick is the one kind of error a reader acts on before noticing.
...
- Set-piece & penalties: Penalties Woltemade. Free-kicks Hall, Botman/Schar. Corners Hall, Elanga. **20 Aug: Bruno G struck from all three for the same reason.** What he vacated is NOT reassigned here: a new head coach re-cuts the dead-ball order, and guessing at it would replace a wrong answer with an invented one. **The Guardian's own read is that Newcastle have lost their leading four chance creators in a single window — Guimaraes, Tonali, Gordon and Trippier — so treat every creative projection in this block as unsupported until GW1–3 team sheets say who has taken over.**
...
**Pre-season summary:** Fourteenth, comfortable survival in their first season back, Daniel Farke continues. Direction is clear consolidation: sell high-value fringe assets (Struijk to Brighton) and reinvest in PL-ready bodies, with a striker rebuild. Key storyline is the forward line, Calvert-Lewin already reported carrying a pre-season injury blow, pushing Nmecha to the fore. Leeds were among the league's best set-piece scorers last term.

**In:** Tarik Muharemovic (CB, Sassuolo, ~£34.1m), Lukas Nmecha (ST, Wolfsburg), Dominic Calvert-Lewin (ST, free, reported through medical, confirm fitness), Sebastiaan Bornauw (CB, reported), Harry Wilson (AM/W, Fulham, free).

**Out:** Pascal Struijk (CB, Brighton, ~£18m), Jack Harrison (LW, New England Revolution), Illan Meslier (released), Karl Darlow (Man Utd, free), Isaac Schmidt (Young Boys, ~£1.1m), Junior Firpo (free), Harry Gray (loan).

**FPL picks:**
- Value: Harry Wilson, cheap attacking midfielder on free-kicks and corners, a strong budget enabler. Lukas Nmecha as a likely nailed cheap-ish striker given the Calvert-Lewin cloud.
- Premium / captaincy: None obvious. Calvert-Lewin would be nearest, but is injury-flagged, monitor rather than commit.
...
**20 Aug, from the Guardian's Forest preview (Will Unwin):** Glasner and the 3-4-2-1 are corroborated, and so is the chaos behind them — four head coaches in one season, none of whom left with a positive expected goal difference. One gap: it names **Ousmane Diomande (DEF, Sporting, ~£34m)** as the only signing to have cost Forest a fee this summer, and this In list does not hold him at all. Added as owed, not silently merged — Hutchinson, McAtee and Ndoye sit in the list above as 2026 arrivals while the same preview describes McAtee's "first season in Nottingham" and a "difficult first year" for Ndoye, which would make them 2025 business. The window each belongs to is now open.
...
## 17. Tottenham Hotspur (41 pts)

**Pre-season summary:** A dismal seventeenth triggered a full rebuild under Roberto De Zerbi, confirmed head coach. Spurs have been the window's biggest spenders (around £237m gross), headlined by British-record-scale midfield outlay on Tonali (~£100m) and Mateus Fernandes (~£85m). Two free veterans (Robertson, Senesi) add defensive experience alongside van Hecke. The story is whether De Zerbi's possession style can lift a talented but recently fragile squad quickly.
...
## 19. Ipswich Town (Promoted, Championship runners-up)
...
## 20. Hull City (Promoted, play-off winners)
...
**Cheap defender enablers with upside:** Gabriel (Arsenal), Daniel Munoz (Palace), Antonee Robinson (Fulham), Milan van Ewijk (Coventry), Leif Davis (Ipswich), De Cuyper (Brighton), Neco Williams (Forest).

**Set-piece and penalty magnets:** Bruno Fernandes (pens, FKs, corners), Gibbs-White (pens, FKs), Palmer (pens), Igor Thiago (pens), Watkins (pens), Woltemade (pens), Ndiaye (pens), Le Fee (pens), McBurnie (pens), Haji Wright (pens).
...
- Final 2025/26 table: [NBC Sports](https://www.nbcsports.com/premier-league-table-2025-26-season-standings)
- 2026/27 clubs, promotion and relegation: [Premier League](https://www.premierleague.com/en/news/4673099/the-202627-premier-league-season-officially-starts/), [Premier League decided](https://www.premierleague.com/en/news/4668605/everything-thats-been-decided-in-202526-premier-league)
- Fixtures: [Premier League all 380](https://www.premierleague.com/en/news/4675097/all-380-fixtures-for-202627-premier-league-season), [Sky Sports fixtures](https://www.skysports.com/football/news/11661/13555675/premier-league-2026-27-fixtures-dates-schedule)
- Managers: [Premier League manager line-up](https://www.premierleague.com/en/news/4679012/manager-line-up-complete-for-202627-season)
- Transfers (per club): [ESPN every-club tracker](https://www.espn.com/soccer/story/_/id/48955344/premier-league-2026-summer-transfers-all-confirmed-ins-outs-every-club), Sports Mole club transfer features, [Fantasy Football Scout signings tracker](https://www.fantasyfootballscout.co.uk/fpl-2026-27-transfer-news-confirmed-summer-signings)
- Big fees: [Sky (Anderson £116m)](https://www.skysports.com/football/news/11095/13558090/elliot-anderson-to-man-city-midfielder-completes-record-breaking-lb116m-transfer-from-nottingham-forest), [Sky (Semenyo £64m)](https://www.skysports.com/football/news/11095/13491956/antoine-semenyo-joins-man-city-bournemouth-forward-signs-in-lb64m-transfer-to-take-city-spending-over-lb425m-in-12-months)
