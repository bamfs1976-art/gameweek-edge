...
const TASKS = {
  ...
  season: {
    instruction: "Write the manager's season narrative from the `season` data: about 170 words in three short paragraphs. Cover the rank journey (weeks, points, rank now and best), captaincy (accuracy, points missed, the return against the field's captain), transfers (count, net points, hits), the bench, any chips and the costliest decisions listed. Quote only figures that appear in the data and name only players it names. Plain, calm, no hype. End with one practical lesson for the rest of the season. Never use an em dash.",
    model: 'claude-sonnet-5', max: 700, pro: true
  },
  draft: {
